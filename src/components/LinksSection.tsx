...
export const LinksSection: FC<LinksSectionProps> = ({ lang, openUrl }) => {
    ...
    return (
        <PanelSection title={`🔗 ${t("links", lang)}`}>
            {/* Ko-fi Support */}
            <PanelSectionRow>
                <div style={{ padding: "0 12px 8px 12px", background: "rgba(255,255,255,0.01)", borderRadius: "8px", width: "100%" }}>
                    ...
                    {showKofiQR && (
                        <div style={{ display: "flex", justifyContent: "center", padding: "12px", background: "#fff", borderRadius: "8px", marginTop: "12px", marginLeft: "4px", marginRight: "4px" }}>
            ...
            {/* USDT Support */}
            <PanelSectionRow>
                <div style={{ padding: "0 12px 8px 12px", background: "rgba(255,255,255,0.01)", borderRadius: "8px", width: "100%", marginTop: "4px" }}>
                    <div style={{ display: "flex", alignItems: "center", gap: "12px", padding: "12px 0" }}>
                    ...
                    {showUsdtQR && (
                        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", padding: "12px", background: "#fff", borderRadius: "8px", marginTop: "12px", marginLeft: "4px", marginRight: "4px" }}>
